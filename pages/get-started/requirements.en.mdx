...
<Callout type="info" emoji="ℹ️">
  Please note that those information can vary a lot based on the network you are
  currently running.
</Callout>
...
<Callout type="warning" emoji="⚠️">
  Since the state of your network keeps growing, it is important to plan for
  slightly more storage than necessary to avoid maintenance.
</Callout>
...
<Callout type="info" emoji="ℹ️">
  Now that you have the right system requirements you can head up to the
  [**Installation**](/get-started/install) section were you'll learn how to
  install and configure your Madara client.
</Callout>

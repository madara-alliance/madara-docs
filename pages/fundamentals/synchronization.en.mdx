...
<Callout type="info" emoji="ℹ️">
  This section is about Full Nodes syncronisation only. Starknet doesn't have
  P2p yet, Full Nodes syncronise trough the FGW, check the [FGW
  section](#syncing-from-the-fgw) down bellow for more informations.
</Callout>

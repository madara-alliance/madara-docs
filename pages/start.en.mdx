...
Congratulations! Your Custom App Chain is running smoothly. Now let's interact with it and make our first transfer.

### Interact with your App Chain

Maintenant que vous avez votre Sequencer qui tourne correctement il vous fa

To allow users and applications to interact with your chain, you need to expose a public RPC endpoint.
...
- **Configure Firewall**: Ensure that port `9944` (or your chosen port) is open and accessible.

### Enable Metrics and Analytics

Monitoring your chain's performance is essential.

- **Enable Prometheus Metrics**:

  ```bash
  --prometheus-port 9615 --prometheus-external
  ```

- **Set Up Grafana Dashboard**: Use Prometheus data to visualize metrics in Grafana.

## Test Your Chain

Before going live, thoroughly test your chain to ensure stability and performance.

### Use a Block Explorer

A block explorer helps you visualize blocks, transactions, and addresses.

- **Option 1**: Use an existing Starknet block explorer compatible with Madara.

- **Option 2**: Deploy your own block explorer like [Voyager](https://voyager.online/).

### Send Test Transactions

Interact with your chain by sending transactions.

- **Use Wallets**: Tools like Argent X or Braavos can be used to send transactions.

- **Deploy Smart Contracts**: Test deploying and interacting with smart contracts on your chain.

## Launch Your Chain on Mainnet

After thorough testing, you're ready to launch your chain on the mainnet.

- **Ensure Compliance**: Make sure your chain adheres to Starknet's protocol requirements.

- **Backup Data**: Secure your chain's data by setting up regular backups.

- **Monitor Continuously**: Keep an eye on your chain's health and performance.

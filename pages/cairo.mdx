...
and to remain credibly neutral and decentralised at the same time. This has led to Ethereum's [rollup-centric roadmap](https://ethereum-magicians.org/t/a-rollup-centric-ethereum-roadmap/4698)
...
of rollups in the future. While each rollup is going to be different in terms of business logic and use cases, the technical fundamentals largely fall into on of the
...
In short, Optimistic rollups are good solutions until we have don't have efficient and cheap ZK tech to verify execution. However, once we have that - an ergonomic programming language which
...
Cairo has been been built by Starkware (the pioneers of ZK technology) and has been optimized for proving and
...
While the Solidity is an older and more popular language for writing smart contracts, it's also the first attempt to creating
a smart contract language. As a result, it has had a lot of shortfalls that Cairo solves keep proving aside. This includes but is
...
to get tested. On the other hand, Cairo based app chains go as back as early as [2021](https://dydx.exchange/blog/public). The Cairo tech has been

...
<Callout type="info" emoji="ℹ️">
  We recommend continuing with the [Next Section](#build-your-chain-from-source), which will help you better understand the different components of Madara by building from source.
</Callout>
